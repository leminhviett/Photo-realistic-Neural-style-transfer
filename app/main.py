...
def upload_file():
    ...
    if request.method == 'POST':
        ...
        output[0] = "in1_sum_encoder_skip." + str(content.filename).split(".")[-1]
...
def stylize():
      #hard code
      os.system('python transfer.py --option_unpool sum -e -s --content ./upload/content --style ./upload/style --content_segment ./segment_res/content --style_segment ./segment_res/style/ --output ./static/ --verbose --image_size 512')
